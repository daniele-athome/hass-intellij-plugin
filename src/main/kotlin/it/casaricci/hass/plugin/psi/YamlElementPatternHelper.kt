...
object YamlElementPatternHelper {
    ...
    fun getScalarKeyWithRootParentKey(rootKeyName: String): PsiElementPattern.Capture<PsiElement> {
        return PlatformPatterns.psiElement(YAMLTokenTypes.SCALAR_KEY).withParent(
            PlatformPatterns.psiElement(YAMLKeyValue::class.java).withParent(
                PlatformPatterns.psiElement(YAMLMapping::class.java).withParent(
                    PlatformPatterns.psiElement(YAMLKeyValue::class.java).withName(rootKeyName)
                        .withParent(
