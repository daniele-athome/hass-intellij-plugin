...
class MockHassRemoteRepository(
    project: Project,
    jsonStatesPath: String?,
    jsonServicePath: String?,
    ...
    init {
        if (jsonStatesPath != null) {
            ...
            val jsonStatesFile =
                PsiFileFactory.getInstance(project)
                    .createFileFromText("ha_states.json", JsonFileType.INSTANCE, jsonStatesData)
                    as JsonFile
        ...
        if (jsonServicePath != null) {
            ...
            val jsonServicesFile =
                PsiFileFactory.getInstance(project)
                    .createFileFromText("ha_services.json", JsonFileType.INSTANCE, jsonServicesData)
                    as JsonFile
    ...
    ): Collection<JsonStringLiteral>? = states

    override fun getServices(module: Module): Collection<JsonProperty>? = services
}
